...
export function HeroHostSection({ data, storyEnabled = true }: HeroHostSectionProps) {
  ...
  return (
    <section
      id="host_info"
      className="template-section bg-[var(--event-bg,#0f172a)] relative isolate overflow-hidden min-h-0 pt-6 pb-12 sm:pt-8 sm:pb-14 lg:pt-8 lg:pb-12 text-[var(--event-on-dark,#f8fafc)]"
    >
