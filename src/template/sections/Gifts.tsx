...
export function GiftsSection({ data }: { data: GiftsData }) {
  ...
  return (
    <section
      id="gift_details"
      className="template-section section-surface-ivory pattern-archival-dot pattern-subtle"
    >
      <div className="template-container-narrow">
        ...
        <Reveal direction="up" distance={20} delay={0.1}>
          <LedgerPanel
            ...
            headerAlign="center"
            className="max-w-2xl mx-auto bg-[var(--wedding-surface)] shadow-card space-y-6"
          >
            {data.giftNote && (
