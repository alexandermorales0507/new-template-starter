...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-xl bg-[var(--event-surface-alt)] p-1 text-[var(--event-text-muted)] border border-[var(--event-border)] gap-1 font-sans",
      className
    )}
    {...props}
  />
